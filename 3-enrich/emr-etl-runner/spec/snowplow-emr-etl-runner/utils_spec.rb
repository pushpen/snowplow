  ...
  describe '#get_failure_details' do
    ...
    let(:expected_output) {
      [
        ...
        "JOB ID: TERMINATED [ALL_STEPS_COMPLETED] ~ 00:36:29 [2015-07-13 14:00:42 +0200 - 2015-07-13 14:37:12 +0200]",
        " - 1. Elasticity Custom Jar Step: COMPLETED ~ elapsed time n/a [ - 2015-07-13 14:37:12 +0200]"
      ]
        .join("\n")
    }
